...
require_once 'Tina_Error.php';
require_once 'Tina_ActionClass.php';
require_once 'Tina_ActionForm.php';
require_once 'Tina_ViewClass.php';
require_once 'Tina_UrlHandler.php';

/**
 *  Tina application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Tina
 */
class Tina_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
